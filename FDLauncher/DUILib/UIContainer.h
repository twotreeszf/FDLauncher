...
public:
    ...
    virtual int GetScrollLenth() const;
    virtual void SetChildPadding(int iPadding);
    virtual void SetScrollLenth(int iScrollLenth);
	...
	CStdPtrArray& GetItemsArray() { return m_items; } 
protected:
...
public:
    ...
    void SetChildVPadding(int nChildVPadding);
    int GetChildHPadding() const;
    void SetChildHPadding(int nChildHPadding);
...
protected:
    SIZE m_szItem;
    int m_nColumns;
    int m_nChildVPadding;
    int m_nChildHPadding;
};
