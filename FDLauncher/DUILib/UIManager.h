...
public:
	...
	CStdString GetInstancePath();	
	const  CStdString& GetResourcePath();
	...
	DWORD FastFindZipItem(HANDLE hz, const TCHAR *name, bool ic, int *index, void *ze);
	DWORD FastUnzipItem(HANDLE hz, const TCHAR *name, int index, void *dst, unsigned int len, DWORD flags);
	void  RemoveZipCache(const TCHAR *name);
	void  ExtractZipInMemory(long maxSize = -1);
protected:
	...
	CStdStringPtrMap m_zipItemCache;
	CRITICAL_SECTION m_csItemCache;
};
/////////////////////////////////////////////////////////////////////////////////////
//
typedef CControlUI* (*LPCREATECONTROL)(LPCTSTR pstrType);

typedef HINSTANCE (*LPSHELLEXECUTEHOOK)(HWND hwnd, LPCTSTR lpOperation, LPCTSTR lpFile, 
...
public:
    void Init(HWND hWnd, CResourceUI* pRes);
    void NeedUpdate();
	...
	static HINSTANCE ShellExecuteX(__in_opt HWND hwnd, 
	...
	static void SetShellEcecuteHook(LPSHELLEXECUTEHOOK pHook);
	...
	void AddStyleAttributeList(LPCTSTR pStrStyleName, LPCTSTR pStrStyleAttrList);
	LPCTSTR GetStyleAttributeList(LPCTSTR pStrStyleName) const;
	bool RemoveStyleAttributeList(LPCTSTR pStrStyleName);
	const CStdStringPtrMap& GetStyleAttribultes() const;
    ...
    void AddDelayedCleanup(CControlUI* pControl, bool bPostMessage = true);
	...
	CControlUI* GetParentByClass(CControlUI* pSubControl, LPCTSTR pstrClass);
...
private:
	...
	CStdStringPtrMap m_StyleAttrHash;

	CResourceUI*  m_pResource;
    //
	...
	static LPSHELLEXECUTEHOOK m_pShellExecuteHook;	
};
