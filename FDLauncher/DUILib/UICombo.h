...
public:
    ...
    void SetDropboxMoveLeft(int iDropboxMoveLeft);
    int GetDropboxMoveLeft() const;
	...
	void ModifyDropBoxSize(int deltLeft, int deltTop, int deltRight, int deltBottom);
