...
public:
    ...
    static TImageInfo* LoadImage(CResourceUI* pResource, STRINGorID bitmap, LPCTSTR type = NULL, DWORD mask = 0);
    ...
    static void DrawFanShape(HDC hDC, const RECT& rc, float startAngle, float sweepAngle, DWORD dwFillColor, \
        bool bDrawBorder, DWORD dwBorderColor, float borderWidth);
    static void FillEllipse(HDC hDC, const RECT& rc, DWORD dwFillColor);
